<template>
  <div class="container">
    <table class="table table-dark" data-cy="activity-table">
      <thead>
        <tr>
          <th scope="col">#</th>
      ...
      <tbody data-cy="activity-table-body">
...
export default {
  ...
  methods: {
    getMessage() {
      ...
      const ninetyDaysAgo = (new Date(new Date().setDate(currentDate.getDate() - 90))) / 1000;
